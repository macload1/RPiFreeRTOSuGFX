...
/*!
    ...
    \warning
 */
#define SL_OS_WAIT_FOREVER                      ((OsTime_t)OS_WAIT_FOREVER)
...
/*!
    ...
    \warning
 */
#define SL_OS_NO_WAIT                            ((OsTime_t)OS_NO_WAIT)
...
/*!
    ...
    \warning
 */
#define sl_SyncObjCreate(pSyncObj,pName)            SemaphoreP_create(pSyncObj)
...
/*!
    ...
    \warning
 */
#define sl_SyncObjSignalFromIRQ(pSyncObj)           SemaphoreP_post_from_isr(pSyncObj)
...
/*!
    ...
    \warning
 */
#define sl_LockObjCreate(pLockObj, pName)     Mutex_create(pLockObj)
...
/*!
    ...
    \warning
 */
#define sl_LockObjDelete(pLockObj)                  Mutex_delete(pLockObj)
...
/*!
    ...
    \warning
 */
#define sl_LockObjLock(pLockObj,Timeout)          Mutex_lock(pLockObj,Timeout)
...
/*!
    ...
    \warning                User must implement he's own 'os_Spawn' function.
 */
