...
int32_t (*MQTTServerUtil_dbgPrn)(const char *fmt,
                                 ...) = NULL;
...
//
//*****************************************************************************
static MQTT_Packet_t * server_mqp_alloc(uint8_t msgType,
                                        uint32_t buf_sz,
                                        uint8_t offset)
{
...
//
//*****************************************************************************
MQTT_Packet_t * MQTTServerUtil_mqpAlloc(uint8_t msgType,
                                        uint32_t buf_sz)
{
