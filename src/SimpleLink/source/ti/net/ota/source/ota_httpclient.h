...
extern int16_t HttpClient_Connect(uint8_t *ServerName,
                                  int32_t IpAddr,
                                  int32_t Port,
                                  int32_t Secured,
                                  int32_t NonBlocking);
extern int16_t HttpClient_CloseConnection(int16_t SockId);
extern int16_t HttpClient_Recv(int16_t SockId,
                               void *pBuf,
                               int16_t Len,
                               int16_t Flags,
                               int16_t MaxEagain);
extern int16_t HttpClient_RecvAppend(int16_t SockId,
                                     uint8_t *pRecvBuf,
                                     int16_t RecvBufSize,
                                     int16_t RecvLen,
                                     int16_t RecvOffset);
extern int16_t HttpClient_RecvSkipHdr(int16_t SockId,
                                      uint8_t *pRespBuf,
                                      int16_t RespBufSize,
                                      uint32_t *contentLen);
extern int16_t HttpClient_SendReq(int16_t SockId,
                                  uint8_t *pHttpReqBuf,
                                  uint8_t *pReqMethod,
                                  uint8_t *pServerName,
                                  uint8_t *pUriPrefix,
                                  ...
                                  uint8_t *pHdrName,
                                  uint8_t *pHdrVal);
extern uint8_t * HttpClient_ParseUrl(uint8_t *pUrlName,
                                     uint8_t *PServerName,
                                     int16_t *Status);
